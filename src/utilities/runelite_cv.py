...
def object_list(color, trim=4, trim_iter=1):
    ...
    Afterwards it finds all the countours from the mask image Morphological Transformations to get rid of the
    ...
    you can have border width of 4 or greater and highlight only clickboxes or you can have 1 border and highlight hull only.
    Args:
    ...
    Returns:
        Returns a list of all the hightlighted objects. Each object is list, first index is the center of the object, second is the
        object width and height, third is the x and y axis of the start box of the object in the left top corner, lastly
        is the all the clickable pixel points in the object.
    '''
