...
class OSNRBot(RuneLiteBot, metaclass=ABCMeta):
    ...
    def __disable_private_chat(self):
        ...
        pag.rightClick()
        time.sleep(0.05)
        self.mouse.move_to(show_none_btn)
        pag.click()
    ...
    def close_bank(self):
        ...
        self.mouse.move_to(self.bank_close_btn, destination_variance=1)
        pag.click()
        time.sleep(1)
    ...
    def load_preset(self):
        ...
        self.mouse.move_to(self.presets_btn, destination_variance=2)
        pag.click()
        time.sleep(1)
        self.mouse.move_to(self.presets_load_btn, destination_variance=1)
        pag.click()
        time.sleep(1)
        self.mouse.move_to(self.presets_close_btn, destination_variance=1)
        pag.click()
        time.sleep(1)
    ...
    def teleport_home(self, spellbook: Spellbook):
        ...
        self.mouse.move_to(self.cp_spellbook, destination_variance=2)
        pag.click()
        time.sleep(0.5)
    ...
    def toggle_auto_retaliate(self, toggle_on: bool):
        ...
        self.mouse.move_to(self.cp_combat, destination_variance=3)
        pag.click()
        time.sleep(0.5)
